...
export class ListFormat {
  ...
  public format(list?: Iterable<string>): string {
    ...
    if (!(lf instanceof Object)) {
      throw new TypeError(
        `Method Intl.ListFormat.prototype.format called on incompatible receiver ${this.toString()}`
      );
    }
  ...
  public formatToParts(list?: Iterable<string>): ListPartitions {
    ...
    if (!(lf instanceof Object)) {
      throw new TypeError(
        `Method Intl.ListFormat.prototype.formatToParts called on incompatible receiver ${this.toString()}`
      );
    }
  ...
  public resolvedOptions(): ResolvedListFormatOptions {
    ...
    if (!(lf instanceof Object)) {
      throw new TypeError(
        `Method Intl.ListFormat.prototype.resolvedOptions called on incompatible receiver ${this.toString()}`
      );
    }
